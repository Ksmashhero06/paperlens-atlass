...
import { N as globalthis_default } from "../_libs/@firebase/app+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BKs8Q7z0.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-ClHQqvmk.mjs").then((n) => n.t),
		import("./start-BmnxHFQJ.mjs"),
		import("./empty-plugin-adapters-D4hJlBhF.mjs")
	]);
	return {
		routerEntry,
		startEntry,
